...
const TILES: Tile[] = [
  { title: 'Chats', sub: 'Direct & group', icon: MessageSquare, to: '/chats', color: 'var(--sb-primary)', bg: 'var(--sb-primary-soft)' },
  ...
  { title: 'Anonymous', sub: 'Speak freely', icon: VenetianMask, to: '/anon', color: 'var(--sb-anon)', bg: 'var(--sb-anon-soft)' },
]
